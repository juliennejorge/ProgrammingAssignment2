...
## makeCacheMatrix : It creates a matrix that will be able to cache its inverse
makeCacheMatrix <- function(x = matrix()) {
  ...
  ## Step 3 : Setting the values of the inverse matrix
...
## cacheSolve : Calculate the inverse of the cache matrix
